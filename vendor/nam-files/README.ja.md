...
`src/webfont/build.py` の `google-korean` strategy が、`slices/korean_default.txt` を読み込みます。各 slice に含まれるコードポイントと Gen Interface KR Regular の cmap を intersect し、実際にフォントが持つグリフだけを subset WOFF2 にします。
